...
echo "<th>Id</th>";
echo "<th>Nom</th>";
echo "<th>Circonférence en km</th>";
echo "<th>Distance en km</th>";
...
echo"<form action='enregistrement.php' method='POST'>";
  ...
  echo"<label for='Circonférence'>Circonférence en km:</label>";
  echo "<input type='number' name='Circonférence' required>";
  echo"<br>";
  echo"<label for='Distance'>Distance en km:</label>";
  echo "<input type='number' name='Distance' required>";
  echo"<br>";
  echo"<label for='Documentation'>Documentation :</label>";
  echo"<input type='text' name='Documentation' required>";
  echo "<br>";
